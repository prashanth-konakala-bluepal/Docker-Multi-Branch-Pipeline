						 	...
						 	steps
								{
								 sshagent(['Docker'])
										{
										 	ssh scp -o StrictHostKeyChecking=no /var/lib/jenkins/workspace/Docker-Multi-Containers_main/webapp/target/master.war ubuntu@3.142.196.56:/opt/warfiles/master/
